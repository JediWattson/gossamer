...
func TestComputedPropertyValueSerializesEverySupportedLonghand(t *testing.T) {
	computed := ComputedStyle{
		...
		textOrientation: TextOrientationUpright,
...
func TestComputedPropertyValueSerializesInitialAndAlternateEnums(t *testing.T) {
	tests := []struct {
		...
		{name: "mixed text orientation", property: "text-orientation", want: "mixed"},
		{name: "upright text orientation", computed: ComputedStyle{textOrientation: TextOrientationUpright}, property: "text-orientation", want: "upright"},
		{name: "sideways text orientation", computed: ComputedStyle{textOrientation: TextOrientationSideways}, property: "text-orientation", want: "sideways"},
		...
		{name: "inline table display", computed: ComputedStyle{display: DisplayInlineTable}, property: "display", want: "inline-table"},
		{name: "table row group display", computed: ComputedStyle{display: DisplayTableRowGroup}, property: "display", want: "table-row-group"},
		{name: "table header group display", computed: ComputedStyle{display: DisplayTableHeaderGroup}, property: "display", want: "table-header-group"},
		{name: "table footer group display", computed: ComputedStyle{display: DisplayTableFooterGroup}, property: "display", want: "table-footer-group"},
		{name: "table row display", computed: ComputedStyle{display: DisplayTableRow}, property: "display", want: "table-row"},
		{name: "table cell display", computed: ComputedStyle{display: DisplayTableCell}, property: "display", want: "table-cell"},
		{name: "table column group display", computed: ComputedStyle{display: DisplayTableColumnGroup}, property: "display", want: "table-column-group"},
		{name: "table column display", computed: ComputedStyle{display: DisplayTableColumn}, property: "display", want: "table-column"},
		{name: "table caption display", computed: ComputedStyle{display: DisplayTableCaption}, property: "display", want: "table-caption"},
