...
## Framework wrapper milestones 4-7
...
The next wrapper slice is interface specialization and broader browser state:
dedicated HTML form-control prototypes, radio/select/option coordination,
selection ranges and composition, navigation/history, and window geometry.
